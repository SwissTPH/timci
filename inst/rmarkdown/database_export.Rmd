...
```{r, echo=FALSE}
if (params$rctls_dir == "") {
  params$rctls_dir <- tempdir()
}
if (params$participant_zip == "") {
  params$participant_zip <- file.path(tempdir(),"participants.zip")
}
if (params$spa_dir == "") {
  params$spa_dir <- tempdir()
}
if (params$qual1_dir == "") {
  params$qual1_dir <- tempdir()
}
```
