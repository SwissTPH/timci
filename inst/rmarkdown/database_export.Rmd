...
qc_inconsistent_age_info <- "DQC_00_0SG_09"
qc_underaged_cg_id <- "DQC_00_0SG_10"
qc_dup_repeats_id1 <- "DQC_00_0SG_11a"
qc_dup_repeats_id2 <- "DQC_00_0SG_11b"

# Day 0 drug quality check IDs
###############################
qc_duplicate_drug <- "DQC_00_1DG_01"
qc_amox_consistency_drug <- "DQC_00_1DG_02"
qc_aclav_consistency_drug <- "DQC_00_1DG_03"
qc_metro_consistency_drug <- "DQC_00_1DG_04"
qc_ctx_consistency_drug <- "DQC_00_1DG_05"
qc_cipro_consistency_drug <- "DQC_00_1DG_06"
qc_genta_consistency_drug <- "DQC_00_1DG_07"
qc_penig_consistency_drug <- "DQC_00_1DG_08"
qc_ceftriaxone_consistency_drug <- "DQC_00_1DG_09"
qc_cefixime_consistency_drug <- "DQC_00_1DG_10"
qc_ampi_consistency_drug <- "DQC_00_1DG_11"
qc_azi_consistency_drug <- "DQC_00_1DG_12"
qc_benza_consistency_drug <- "DQC_00_1DG_13"
qc_cefadroxil_consistency_drug <- "DQC_00_1DG_14"
qc_doxycycline_consistency_drug <- "DQC_00_1DG_15"
qc_erythromycin_consistency_drug <- "DQC_00_1DG_16"
qc_flucloxacillin_consistency_drug <- "DQC_00_1DG_17"
qc_mupirocin_consistency_drug <- "DQC_00_1DG_18"
qc_tetracycline_consistency_drug <- "DQC_00_1DG_19"
qc_isionazid_consistency_drug <- "DQC_00_1DG_20"
qc_rifampicin_consistency_drug <- "DQC_00_1DG_21"
qc_RH_consistency_drug <- "DQC_00_1DG_22"
qc_RHZE_consistency_drug <- "DQC_00_1DG_23"
qc_artesunate_consistency_drug <- "DQC_00_1DG_24"
qc_arthemeter_consistency_drug <- "DQC_00_1DG_25"
qc_AL_consistency_drug <- "DQC_00_1DG_26"
qc_ASAQ_consistency_drug <- "DQC_00_1DG_27"
qc_DHAPPQ_consistency_drug <- "DQC_00_1DG_28"
qc_primaquine_consistency_drug <- "DQC_00_1DG_29"
qc_quinine_consistency_drug <- "DQC_00_1DG_30"

# Day 0 quality check IDs
##########################
qc_inconsistent_facility_info1 <- "DQC_00_2ED_01a"
qc_inconsistent_facility_info2 <- "DQC_00_2ED_01b"
qc_nonvalid_fid1 <- "DQC_00_2ED_02a"
qc_nonvalid_fid2 <- "DQC_00_2ED_02b"
qc_true_duplicates <- "DQC_00_2ED_03"
qc_duplicate_id1 <- "DQC_00_2ED_03a"
qc_duplicate_id2 <- "DQC_00_2ED_03b"
qc_ambiguous_enrolment_date1 <- "DQC_00_2ED_04"
qc_ambiguous_enrolment_date2 <- "DQC_00_2ED_05"
qc_multiple_enrolment_id <- "DQC_00_2ED_06"
qc_multiple_enrolment_sex_discrepancy_id <- "DQC_00_2ED_07"
qc_missing_cp_id <- "DQC_00_2ED_08"
qc_missing_diagnosis_id <- "DQC_00_2ED_09"
qc_missing_referral_id <- "DQC_00_2ED_10"
qc_missing_treatment_id <- "DQC_00_2ED_11"
qc_negative_nb_days_id <- "DQC_00_2ED_12"
qc_free_text_rx_id <- "DQC_00_2ED_13"
qc_pox_ <- "DQC_00_2ED_14"
qc_summary_id <- "DQC_00_2ED_15"
...
```{r db-export-repeats-subsection, child = if(test) 'database_export_sub_rctls_repeats.Rmd'}
```
