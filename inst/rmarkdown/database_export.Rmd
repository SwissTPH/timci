...
cat(paste0("There are ", nrow(locked_day0_data), " submissions at Day 0 in the raw facility data."))
```
...
```{r, results = 'asis'}
cat(paste0("There are ", nrow(locked_day0_data), " submissions at Day 0 in the cleaned facility data."))
```
...
Rule: keep only IDs of children who are enrolled in the cleaned database.
