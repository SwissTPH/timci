...
Rule: child ID duplicates are removed from the cleaned database.
...
if (!is.null(facility_data)) {
  if (nrow(day0_data) > 0) {
    if (nrow(id_duplicates) > 0) { 
      ...
      day0_data_clean <- day0_data[!day0_data$child_id %in% id_duplicates$child_id, ]
      day0_data_id_duplicates <- pii[day0_data$child_id %in% id_duplicates$child_id, ]
      cat(paste0(nrow(id_duplicates), " ID duplicates were detected and removed from the database at Day 0."))
    } else {
...
if (!is.null(facility_data)) {
  ...
  if (deidentification_on == 1) {
    ...
    deidentified_day0_data_clean <- timci::deidentify_data(day0_data_clean)
    fn <- timci::export_df2xlsx(deidentified_day0_data_clean, params$rctls_dir,
                                "02a_timci_day0_data_clean")
    fn <- timci::export_df2csv(deidentified_day0_data_clean, params$rctls_dir,
                               "02a_timci_day0_data_clean")
    
    deidentified_day0_data_id_duplicates <- timci::deidentify_data(day0_data_id_duplicates)
    fn <- timci::export_df2xlsx(deidentified_day0_data_id_duplicates, params$rctls_dir,
                                "02b_timci_day0_data_id_duplicates")
    fn <- timci::export_df2csv(deidentified_day0_data_clean, params$rctls_dir,
                               "02b_timci_day0_data_id_duplicates")
    ...
    fn <- timci::export_df2xlsx(day0_data_clean, params$rctls_dir,
                                "02a_timci_day0_data_clean")
    fn <- timci::export_df2csv(day0_data_clean, params$rctls_dir,
                               "02a_timci_day0_data_clean")
    
    fn <- timci::export_df2xlsx(day0_data_id_duplicates, params$rctls_dir,
                                "02b_timci_day0_data_id_duplicates")
    fn <- timci::export_df2csv(day0_data_id_duplicates, params$rctls_dir,
                               "02b_timci_day0_data_id_duplicates")
  }
