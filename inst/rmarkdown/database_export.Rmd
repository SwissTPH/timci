...
```{r}
qc_day0_after_lockdate <- "DQC_00_01"
qc_nonvalid_fid1 <- "DQC_00_01a"
qc_nonvalid_fid2 <- "DQC_00_01b"
qc_underaged_cg_id <- "DQC_00_02"
qc_nontimely_completion_id <- "DQC_00_03"
qc_incorrect_enrolment_date <- "DQC_00_03"
qc_nontimely_submission_id <- "DQC_00_04"
qc_duplicate_id1 <- "DQC_00_05a"
qc_duplicate_id2 <- "DQC_00_05b"
qc_multiple_enrolment_id <- "DQC_00_06"
qc_multiple_enrolment_sex_discrepancy_id <- "DQC_00_07"
qc_missing_cp_id <- "DQC_00_08"
qc_summary_id <- "DQC_00_09"
qc_pids_out_lock_range_day7fu <- "DQC_07_01"
qc_nonvalid_day7fu <- "DQC_07_01"
qc_duplicated_day7fu <- "DQC_07_02"
