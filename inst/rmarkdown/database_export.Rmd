...
##############################
qc_nontimely_submission_id <- "DQC_00_01"
qc_nontimely_completion_id <- "DQC_00_02"
qc_screening_w_nonvalid_deviceid <- "DQC_00_03"
qc_screening_other_fids <- "DQC_00_04"
qc_underaged_cg_id <- "DQC_00_05"
qc_dup_repeats_id1 <- "DQC_00_06a"
qc_dup_repeats_id2 <- "DQC_00_06b"
qc_incorrect_date_setup <- "DQC_00_07"
qc_screening_after_lockdate <- "DQC_00_08"

# Day 0 quality check IDs
##########################
qc_nonvalid_fid1 <- "DQC_00_09a"
qc_nonvalid_fid2 <- "DQC_00_09b"
qc_duplicate_id1 <- "DQC_00_10a"
qc_duplicate_id2 <- "DQC_00_10b"
qc_incorrect_enrolment_date <- "DQC_00_11"
qc_multiple_enrolment_id <- "DQC_00_12"
qc_multiple_enrolment_sex_discrepancy_id <- "DQC_00_13"
qc_missing_cp_id <- "DQC_00_14"
qc_missing_diagnosis_id <- "DQC_00_15"
qc_missing_referral_id <- "DQC_00_16"
qc_missing_treatment_id <- "DQC_00_17"
qc_negative_nb_days_id <- "DQC_00_18"
qc_free_text_rx_id <- "DQC_00_19"
qc_drug_duplicate_id <- "DQC_00_20"
qc_pox_ <- "DQC_00_21"
qc_summary_id <- "DQC_00_22"
...
```{r db-export-screening-subsection, child = 'database_export_sub_rctls_context.Rmd'}
```
