...
qc_screening_after_lockdate <- "DQC_00_02"
qc_dup_repeats_id1 <- "DQC_00_03a"
qc_dup_repeats_id2 <- "DQC_00_03b"
qc_nonvalid_fid1 <- "DQC_00_03a"
qc_nonvalid_fid2 <- "DQC_00_03b"
qc_underaged_cg_id <- "DQC_00_04"
qc_incorrect_enrolment_date <- "DQC_00_05"
qc_nontimely_completion_id <- "DQC_00_06"
qc_nontimely_submission_id <- "DQC_00_07"
qc_duplicate_id1 <- "DQC_00_08a"
qc_duplicate_id2 <- "DQC_00_08b"
qc_multiple_enrolment_id <- "DQC_00_09"
qc_multiple_enrolment_sex_discrepancy_id <- "DQC_00_10"
qc_missing_cp_id <- "DQC_00_11"
qc_missing_diagnosis_id <- "DQC_00_12"
qc_missing_referral_id <- "DQC_00_13"
qc_summary_id <- "DQC_00_14"
qc_pids_out_lock_range_day7fu <- "DQC_07_01"
qc_nonvalid_day7fu <- "DQC_07_02"
qc_duplicated_day7fu <- "DQC_07_03"
qc_nonvalid_hospitfu <- "DQC_HS_01"
qc_duplicated_hospitfu <- "DQC_HS_02"
qc_nonvalid_day28fu <- "DQC_28_01"
qc_duplicated_day28fu <- "DQC_28_02"
qc_nonreconciled_withdrawals_id <- "DQC_WD_01"
qc_spa_sco_nonvalid_ids <- "DQC_SP_01"
qc_spa_sco_duplicates <- "DQC_SP_02"
qc_spa_hcpi_nonvalid_ids <- "DQC_SP_03"
qc_spa_hcpi_duplicates <- "DQC_SP_04"
