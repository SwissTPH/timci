...
day7fu_duplicates <- detect_duplicate_participants(day7fu_data$child_id)
knitr::kable(day7fu_duplicates, caption = "Duplicates with same child ID")
```
...
hospit_data_duplicates <- detect_duplicate_participants(hospit_data$child_id)
knitr::kable(hospit_data_duplicates, caption = "Duplicates with same child ID")
```
