...
```{r medical-cost-export-2, eval=is_kenya, results = 'asis'}
medical_cost_export_name <- "01c_timci_medical_cost_health_staff"

if (!is.null(medical_cost_data[[3]])) {
  fn <- timci::export_df2xlsx(medical_cost_data[[3]],
                              cost_dir,
                              medical_cost_export_name)
...
if (!is.null(medical_cost_data[[4]])) {
  fn <- timci::export_df2xlsx(medical_cost_data[[4]],
                              cost_dir,
                              medical_cost_export_name)
