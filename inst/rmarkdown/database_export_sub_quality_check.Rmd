...
**Check output:** The check has detected **`r n_detected`** record(s) (i.e. **`r format(round(n_detected / n_df, digits = 2), nsmall = 2)` %** of all records) with `r qc_text` in the `r db_name` database.
