...
correction_type <- "edit_day0_child_ids_to_correct_facilities"
...
qc_text <- ""
qc_idx <- qc_inconsistent_facility_info1
qc_export_label <- "inconsistent_facility_info1_02_after_childID_correction"
qc_export_description <- "facility information between the child ID and the device is inconsistent"
cat(knitr::knit_child('database_export_sub_quality_check.Rmd',
                      envir = environment(),
                      quiet = TRUE))
...
`r if ( is_senegal | is_tanzania ) {'##### Final check'}`
...
qc_text <- ""
qc_idx <- qc_inconsistent_facility_info1
qc_export_label <- "inconsistent_facility_info1_03_after_childID_and_facilityID_correction"
qc_export_description <- "facility information between the child ID and the device is inconsistent"
cat(knitr::knit_child('database_export_sub_quality_check.Rmd',
                      envir = environment(),
                      quiet = TRUE))
