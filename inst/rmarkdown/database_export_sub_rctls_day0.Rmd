...
`r if ( is_tanzania & !is_pilot ) { paste0('**Initial check ', qc_true_duplicates, 'a**') }`
...
```{r, eval=(is_tanzania&!is_pilot), results='asis'}
mc_description <- ""
...
```{r}
timci::dataset_export(corrected_df,
                      "02",
                      "timci_day0_data_corrected",
                      locked_db_dir,
                      "Cleaned Day 0 data")
```

```{r}
timci::dataset_export(cleaned_df,
                      "02",
                      "timci_day0_data_cleaned",
                      locked_db_dir,
                      "Cleaned Day 0 data")
```
