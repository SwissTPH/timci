...
**Check description:** all participants should have complete information about their diagnosis for their Day 0 visit.
...
```{r, results='asis', eval=!is.null(locked_day0_data)}
qc_description <- "All participants should have complete information about the management at the facility for their Day 0 visit. However, participants may be lost at the exit of the consultation, so that these information may be missing."
qc_rule <- "No modification of the database, only reporting."
