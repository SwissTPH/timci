...
### Lock date [context check `r qc_day0_after_lockdate`]\n\n
...
#### Incorrect enrolment date [compliance check `r qc_incorrect_enrolment_date`]\n\n

**Definition:** the enrolment date is taken as the start of the form, however it may happen that research assistants have reused an old form, so that the enrolment date cannot be
...
`r if ( is_tanzania ) { '#### Test/dummy data removed\n\n' }`
