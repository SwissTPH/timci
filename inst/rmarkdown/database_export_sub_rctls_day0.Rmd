...
ts <- timci::export_df2xlsx(qc_completion_ab1day,
                            qc_dir,
                            qc_completion_fn)
cat(paste0("The table of participants for whom the submission was not finalised on the same day it was started has been exported (**", ts, "**) to **", qc_completion_fn, ".xlsx**."))
```
...
fn <- timci::export_df2xlsx(qc_transfer_ab1day,
                            qc_dir,
                            qc_transfer_fn)
cat(paste0("The table of participants for which the submission was transferred strictly after the day it was finalised is exported (**", ts, "**) to **", qc_transfer_fn, ".xlsx**."))
```
...
```{r, child = 'database_export_sub_rctls_withdrawals.Rmd'}
```
