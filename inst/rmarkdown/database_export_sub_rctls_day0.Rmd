...
qc_description <- ""
qc_rule <- "Records from facility IDs not listed in the first section of this report are detected and corrected proactively where possible."
...
qc_description <- ""
qc_rule <- "Records from facility IDs not listed in the first section of this report are removed in the locked database."
qc_type <- "nonvalid_ids"
df <- locked_day0_data
idcol1 <- "fid"
refdf <- research_facilities
