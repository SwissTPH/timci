...
* from the first 5 characters of the child ID (X-F0001-Pxxxx refers to facility F0001)
* from the device which is used (assuming 1 device is used to screen children in 1 unique facility each day)
