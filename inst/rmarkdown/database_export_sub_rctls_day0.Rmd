...
```{r, eval=timci::is_not_empty(day0_data), results='asis', fig.asp=1}
ggplot2::ggplot(day0_data %>%
                  dplyr::mutate(week = lubridate::floor_date(as.Date(end),
                                                             "week",
                                                             week_start = getOption("lubridate.week.start", 1))),
                ggplot2::aes(x = week, y = spo2_meas1)) +
  ggplot2::geom_point() +
  ggplot2::labs(x = "Weeks",
                y = "Oxygen saturation (in %)") +
