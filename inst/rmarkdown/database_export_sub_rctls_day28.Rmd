...
```{r, results='asis', eval=!is.null(allday28fu_data_uids)}
allday28fu_data_uids_fn <- "DQC_28_01_nonvalid_ids_day28fu"
fn <- timci::export_df2xlsx(allday28fu_data_uids[c("child_id", "uuid")],
                            qc_dir,
                            allday28fu_data_uids_fn)
cat(paste0("The table of Day 28 follow-ups for which the child ID does not correspond to any ID found the locked Day 0 database is exported to **", allday28fu_data_uids_fn, "**"))
```
