...
n_raw_allday7fu_data <- nrow(raw_allday7fu_data)
raw_successday7fu_data <- out[[1]]
```

There are **`r n_raw_allday7fu_data`** records in the raw `r db_name` database.
...
```{r, eval=!is.null(n_raw_allday7fu_data), results='asis'}
...
```{r}
timci::create_screening_qc_flowchart(n_raw_allday7fu_data,
