...
### Non-consistent finalisation and submission dates [Context check `r qc_nontimely_submission_day7fu`]
...
df <- raw_allday7fu_data
idcol1 <- "child_id"
refdf <- rbind(facility_data_before_start, facility_data_after_lock) %>%
...
```{r}
allday7fu_data <- allday7fu_data[ , !(names(allday7fu_data) %in% day7fu_pii_drops)]
```
