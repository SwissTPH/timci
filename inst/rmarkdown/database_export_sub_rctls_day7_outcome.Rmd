...
qc_type <- "missing_date"
df <- day7fu_data %>%
  dplyr::mutate(all_hf_visit_day7 = ifelse(status_day7 == 2 | (status_day7 != 2 & hf_visit_day7 == 1 & hf_visit_type == hospit_value),
                                           1,
                                           0)) %>%
  dplyr::filter(all_hf_visit_day7 == 1)
col_date <- "date_hosp_day7"
