...
ggplot(qc_df, aes(x = diff)) +
  ggplot2::geom_histogram() +
  ggplot2::labs(x = "Number of days between submission finalisation and transfer",
                y = "Occurences") +
  ggplot2::facet_wrap(~fid_from_device)
# hist(as.numeric(qc_df$diff),
#      breaks = c(1:max(as.numeric(qc_df$diff), na.rm = TRUE)),
#      main = "",
#      cex.axis = tsize, cex.lab = tsize)
```
...
ggplot(qc_df, aes(x = diff)) +
  ggplot2::geom_histogram() +
  ggplot2::labs(x = "Number of days between submission start and finalisation",
                y = "Occurences") +
  ggplot2::facet_wrap(~fid_from_device)
# hist(as.numeric(qc_df$diff),
#      breaks = c(1:max(as.numeric(qc_df$diff), na.rm = TRUE)),
