...
### Discrepancy between finalisation and submission dates [Context check `r qc_nontimely_submission_id`]
...
### Discrepancy between start and completion dates [Context check `r qc_nontimely_completion_id`]
