...
facility_data_before_start <- qc_df %>%
  dplyr::select(date_visit, child_id, uuid)
...
```{r, eval=facility_data_is_not_null, results='asis'}
qc_description <- "Participants who come back to the facility between 1 and 28 days after their enrolment should be recorded as repeat visits. If they are recorded as new enrolments with their participant ID, this creates duplicates in the database."
