...
```{r}
day28fu <- NULL
if (!is.null(params$raw_day28fu_data)) {
  if (nrow(params$raw_day28fu_data) > 0) {
    day28fu <- timci::generate_fu_log(params$pii, params$raw_day28fu_data, 28, 32)
    day28lost <- timci::generate_fu_log(params$pii, params$raw_day28fu_data, 33, 2000)
