...
raw_day7fu_data <- ruODK::odata_submission_get(fid = Sys.getenv("TIMCI_CRF_DAY7_FID"))
...
```{r, echo=FALSE}
form_url <- paste0(ruODK::get_default_url(), "/v1/projects/", ruODK::get_default_pid(), "/forms/", Sys.getenv("TIMCI_CRF_DAY7_FID"))
print(form_url)
# Create a draft form
...
response <- timci::upload_odkc_csv_attachment(ruODK::get_default_un(), ruODK::get_default_pw(), form_url, csv7_fname)
