---
title: "TIMCI `r if(params$fu_fid == Sys.getenv('TIMCI_CRF_DAY7_FID')){'Day 7'} else if(params$fu_fid == Sys.getenv('TIMCI_CRF_DAY28_FID')){'Day 28'}` follow-up - `r params$facility_id` Weekly log"
...
```{r}
fu <- timci::generate_fu_log(pii, raw_fu_data, fu_start, fu_end)
fu <- fu %>%
