...
```{r, echo=TRUE, message=FALSE}
openxlsx::write.xlsx(random_selection_kitui, "kenya_qual_selection_nonreferred_kitui.xlsx", row.names = FALSE, overwrite = TRUE)
```
...
```{r, echo=TRUE, message=FALSE}
openxlsx::write.xlsx(random_selection_kitui_bkp, "kenya_qual_selection_nonreferred_kitui_bkp.xlsx", row.names = FALSE, overwrite = TRUE)
```
