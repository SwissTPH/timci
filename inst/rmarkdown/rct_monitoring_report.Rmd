...
if (Sys.getenv('TIMCI_COUNTRY') == 'Senegal') {
  ...
  age_eligibility_table_cap <-"Âge lors du screening."
  ...
  sick_cap <- "Maladie lors du screening"
  ...
  age_eligibility_table_cap <- "Age at screening."
...
facility_data <- merge(x = facility_data,
                       y = params$research_facilities[, c("deviceid", "facility_name")],
                       by.x = 'device_id',
                       by.y = 'deviceid',
                       all.x = TRUE)
...
baseline_data <- merge(x = baseline_data,
                       y = params$research_facilities[, c("deviceid", "facility_name")],
                       by.x = 'device_id',
                       by.y = 'deviceid',
                       all.x = TRUE)
