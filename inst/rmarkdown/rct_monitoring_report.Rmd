...
completion_summary <- list(
  "Summary" = list(
    ...
    "Attempted" = ~qwraps2::n_perc((found == 0 | found == 1) & hospitalised == 1, prec),
    "Completed" = ~qwraps2::n_perc(found == 1 & hospitalised == 1, prec),
    "Lost" = ~qwraps2::n_perc(found == 96 & hospitalised == 1, prec),
...
clinical_presentation_statistics <- list(
  "Summary" = list(
    "Any danger sign" = ~qwraps2::n_perc(sx_convulsions == 1 | sx_lethargy == 1 | sx_vomit_evthing == 1 | sx_unable_feed == 1, prec),
