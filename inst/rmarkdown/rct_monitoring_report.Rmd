...
```{r load-RCT-LS-environment-variables, echo=FALSE}
...
if (nrow(facility_data) > 0) {
  p <- timci::generate_day_bar_plot(facility_data$date_visit, as.Date(Sys.Date() - w), as.Date(Sys.Date() + 1), "Submissions")
  plot(p)
