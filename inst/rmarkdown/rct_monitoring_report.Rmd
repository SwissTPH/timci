...
cat(title_str)
plot1 <- timci::plot_enrolment_gauge(n_enrolled/(n_screened - n_repeat), plot1_str, 100, 60, 85)
plot2 <- timci::plot_enrolment_gauge(n_enrolled/(days_nb*3.8*9), plot2_str, 100, 60, 85)
```
...
{
  # gauge plots
  plot3 <- timci::plot_enrolment_gauge(n_completed_day7fu/n_due_day7fu, "Day 7 follow-up rate", 100, 80, 90)
