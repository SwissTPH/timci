...
summary_statistics <- list(
  ...
  "Caregiver eligibility" = list(
    "Above 18 years old" = ~qwraps2::n_perc(cg_eligibility == 1, 2)
    ),
...
mother_statistics <- list(
  "Mother age" = list(
    "Below 18" = ~qwraps2::n_perc(underaged_mother == 1, 2),
    "Above 18" = ~qwraps2::n_perc(underaged_mother == 0, 2)
    )
)
