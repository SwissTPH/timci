...
visits %>%
  knitr::kable(col.names = c("Visit", "N"))
```
...
print(format_summary_table(all, age_statistics, facility_name))
```
...
print(format_summary_table(all, sickness_statistics, facility_name))
```
...
print(format_summary_table(all, sick_reason_statistics, facility_name))
```
...
if (!is.null(all) & length(all) > 0 & nrow(all) > 0) {
  print(format_summary_table(all, reason_statistics, facility_name))
}
```
...
print(format_summary_table(all, caregiver_statistics, facility_name))
```
...
print(format_summary_table(all, mother_statistics, facility_name))
```
...
print(format_summary_table(all, summary_statistics, facility_name))
```
...
print(format_summary_table(all, consent_statistics, facility_name))
```
...
if (Sys.getenv('TIMCI_COUNTRY') != 'India') {
  ...
  if (!is.null(pii)) {
    if (nrow(pii) > 0) {
      ...
      print(format_summary_table(all, phone_stats, facility_name))
      ...
      print(format_summary_table(all, contact_details_stats, facility_name))
...
if (nrow(baseline_data) > 0) {
  ...
  print(format_summary_table(all, pox_statistics, facility_name))
...
if (!is.null(day7fu_data)) {
  if (nrow(day7fu_data) > 0) {
    ...
    print(format_summary_table(all, day7_call_stats, district))
...
if (!is.null(day7fu_data)) {
  if (nrow(day7fu_data) > 0) {
    ...
    print(format_summary_table(all, day7_outcome_ss, district))
  }
}
```
...
if (Sys.getenv('TIMCI_COUNTRY') == "Tanzania" || Sys.getenv('TIMCI_COUNTRY') == "India") {
  ...
  if (!is.null(raw_day28fu_data)) {
    if (nrow(raw_day28fu_data) > 0) {
      ...
      print(format_summary_table(all, day28_call_ss, district))
    }
  }
}
```
