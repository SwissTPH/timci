...
timci::export_df2xlsx(deidentified_facility_data, params$main_output_dir, "timci_facility_day0_data")

deidentified_repeat_data <- timci::deidentify_data(repeat_data)
timci::export_df2xlsx(deidentified_repeat_data, params$main_output_dir, "timci_facility_repeat_data")

timci::export_df2xlsx(raw_day7fu_data, params$main_output_dir, "timci_followup_day7_data")
timci::export_df2xlsx(raw_hospit_data, params$main_output_dir, "timci_followup_hospit_data")
timci::export_df2xlsx(raw_day28fu_data, params$main_output_dir, "timci_followup_day28_data")
```
...
```{r, echo=FALSE}
timci::export_df2xlsx(raw_spa_cgei_data, params$spa_output_dir, "timci_spa_exit_interview_data")
timci::export_df2xlsx(raw_spa_fa_data, params$spa_output_dir, "timci_spa_facility_assessment_data")
timci::export_df2xlsx(raw_spa_hcpi_data, params$spa_output_dir, "timci_spa_provider_interview_data")
timci::export_df2xlsx(raw_spa_sco_data, params$spa_output_dir, "timci_spa_consultation_obs_data")
```
