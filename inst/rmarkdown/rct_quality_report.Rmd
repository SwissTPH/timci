---
title: "TIMCI Pragmatic Cluster RCT Data Quality Report"
...
This data quality report covers the period from **`r start_date`** to **`r end_date`**.
...
screening_fname <- file.path(params$output_dir, paste("timci_screening_data", "_", Sys.Date(), ".xlsx", sep = ""))
...
day0_data_fname <- file.path(params$output_dir, paste("timci_facility_day0_data", "_", Sys.Date(), ".xlsx", sep = ""))
...
repeat_data_fname <- file.path(params$output_dir, paste("timci_facility_repeat_data", "_", Sys.Date(), ".xlsx", sep = ""))
openxlsx::write.xlsx(deidentified_repeat_data, repeat_data_fname, row.names = FALSE)

day7fu_data_fname <- file.path(params$output_dir, paste("timci_followup_day7_data", "_", Sys.Date(), ".xlsx", sep = ""))
