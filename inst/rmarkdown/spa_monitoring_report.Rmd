...
if (Sys.getenv('TIMCI_COUNTRY') == 'Senegal') {
  ...
  ch_title2 <- "## Cartes thermiques calendaires\n\n"
  ...
  heatmap2_cap <- "Carte thermique du nombre de soumissions par jour de semaine et par heure"
  ...
  heatmap2_cap <- "Heatmap of the number of submissions per weekday and hour"
  screening_str <- "Screening"
...
```{r, results='asis', fig.cap = heatmap2_cap}
timci::heatmap_wday_hourofday(spa_sco_data,
                              'start')
```
