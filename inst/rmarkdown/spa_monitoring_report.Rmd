...
timci::generate_calendar_heatmap(spa_sco_data,
                                 date)
```
...
timci::generate_calendar_heatmap(spa_cgei_data,
                                 date)
```
...
timci::generate_calendar_heatmap(spa_fa_data,
                                 date)
```
...
timci::generate_calendar_heatmap(spa_hcpi_data,
                                 date)
```
