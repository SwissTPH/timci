...
myxlsx0 <- paste0("C:/Users/langhe/Documents/Tanzania/timci_exports/export_", cdate, "/02_Tanzania_main_study_interim_analysis_lock/08a_Tanzania_quality_checks/02_timci_day0_data.xlsx")
...
df0 <- readxl::read_excel(myxlsx0)
print(nrow(df0))
```
```{r, echo=TRUE, message=FALSE}
df1 <- readxl::read_excel(myxlsx1)
print(nrow(df1))
```

```{r, echo=TRUE, message=FALSE}
df2 <- readxl::read_excel(myxlsx2)
print(nrow(df2))
```
